...
import 'Expectation_Registration_Screen.dart';

class Professional_Register_Screen extends StatefulWidget {
  const Professional_Register_Screen({super.key});

  @override
  State<Professional_Register_Screen> createState() => _Professional_Register_ScreenState();
}

class _Professional_Register_ScreenState extends State<Professional_Register_Screen> {
  //EMPLOYEE IN
  String? employeeVal;
